...
> 在线体验请优先使用页面提供的 Demo 账号。

## ⚠️ 使用说明

本项目目前处于 MVP Demo 阶段，主要用于产品展示、功能验证和校园互助场景探索。在线体验中的用户、教练、预约、评价、场馆及统计数据均为演示数据，不代表复旦大学或健身爱好者社区的正式运营信息。

请勿在当前版本中输入真实密码、联系方式、证件信息、健康隐私或其他敏感数据。项目提供的训练计划、器材说明和安全提示仅用于一般性信息展示，不能替代专业教练、医生或其他专业人员的个性化建议。
